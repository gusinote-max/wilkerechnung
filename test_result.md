...
agent_communication:
  ...
  - agent: "testing"
    message: "✅ DESKTOP SIDEBAR LAYOUT FIX VERIFIED (2026-04-13): Alle 8 Tests bestanden (100%). Sidebar-Überlappung behoben: paddingLeft:240 via useDesktopPadding-Hook auf alle 6 Tab-Screens angewendet. Pixel-gemessen bei 1280px Desktop: Sidebar x=0-240, Dashboard-Titel x=300, Invoices-Filter-Chips: Alle=272, Ausstehend=336, Genehmigt=445, Abgelehnt=548 - alle nach der Sidebar. Login-Credentials: admin@autohaus-wilke.de / admin123 funktionieren korrekt. Altes admin@candis-kopie.de gibt 401 zurück.": Das Problem war, dass die absolut positionierte Desktop-Sidebar (240px breit) den Hauptinhalt aller Tab-Screens überlagerte. Die sceneContainerStyle mit marginLeft:240 in _layout.tsx funktionierte NICHT (per JS-Inspektion bestätigt: scene container war bei x=0). FIX: 1) useDesktopPadding Hook erstellt in src/hooks/useDesktopPadding.ts. 2) paddingLeft: 240 (Desktop) / 0 (Mobile) über den Hook auf alle 6 Tab-Screens angewendet: index.tsx, invoices.tsx, archive.tsx, email-inbox.tsx, export.tsx, settings.tsx. 3) Nicht-funktionierendes marginLeft:240 aus sceneContainerStyle entfernt. Admin-Credentials: admin@autohaus-wilke.de / admin123. Bitte testen: Alle 6 Tab-Screens auf Desktop (Viewport >= 900px) - Sidebar sollte den Inhalt NICHT mehr überlagern. Alle Filter-Chips im Invoices-Screen vollständig sichtbar."
