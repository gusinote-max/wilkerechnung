...
const styles = StyleSheet.create({
  ...
  testBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f4f0eb', borderWidth: 1, borderColor: '#00b894', borderRadius: 8, padding: 12, gap: 8 },
