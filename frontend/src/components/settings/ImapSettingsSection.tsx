...
const styles = StyleSheet.create({
  ...
  switchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#e5ddd5', marginBottom: 16 },
  switchLabel: { fontSize: 15, color: '#2c2c3e', fontWeight: '500' },
  inputGroup: { marginBottom: 14 },
  label: { fontSize: 13, fontWeight: '600', color: '#6e6e85', marginBottom: 7 },
  input: { backgroundColor: '#f4f0eb', borderRadius: 10, padding: 13, fontSize: 14, color: '#2c2c3e', borderWidth: 1, borderColor: '#e5ddd5' },
  ...
  sslLabel: { fontSize: 13, color: '#6e6e85' },
  modeContainer: { flexDirection: 'column', gap: 8 },
  modeButton: { padding: 12, borderRadius: 10, borderWidth: 1, borderColor: '#e5ddd5', backgroundColor: '#f4f0eb' },
  modeButtonActive: { borderColor: '#00b894', backgroundColor: '#00b89415' },
  modeLabel: { fontSize: 14, fontWeight: '600', color: '#6e6e85', marginBottom: 2 },
  modeLabelActive: { color: '#00b894' },
  modeDesc: { fontSize: 12, color: '#9e9eaa' },
  intervalContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  intervalChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: '#e5ddd5', backgroundColor: '#f4f0eb' },
  intervalChipActive: { borderColor: '#00b894', backgroundColor: '#00b89415' },
  intervalText: { fontSize: 13, color: '#6e6e85' },
  ...
  primaryButtonText: { color: '#2c2c3e', fontSize: 14, fontWeight: '700' },
  secondaryButton: { flex: 1, backgroundColor: '#e5ddd5', borderRadius: 10, padding: 14, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: 6 },
