...
const styles = StyleSheet.create({
  ...
  hint: { fontSize: 13, color: '#9e9eaa', marginBottom: 16, lineHeight: 18 },
  ...
  addBtnText: { color: '#2c2c3e', fontWeight: '600', fontSize: 13 },
  form: { backgroundColor: '#f4f0eb', borderRadius: 12, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#e5ddd5' },
  formTitle: { fontSize: 15, fontWeight: '700', color: '#2c2c3e', marginBottom: 12 },
  formRow: { flexDirection: 'column', gap: 0 },
  desktopFormRow: { flexDirection: 'row', gap: 12 },
  inputGroup: { marginBottom: 12 },
  label: { fontSize: 12, fontWeight: '600', color: '#6e6e85', marginBottom: 6 },
  input: { backgroundColor: '#ffffff', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, color: '#2c2c3e', borderWidth: 1, borderColor: '#e5ddd5' },
  ...
  primaryBtnText: { color: '#2c2c3e', fontWeight: '700', fontSize: 14 },
  cancelBtn: { flex: 1, backgroundColor: '#e5ddd5', borderRadius: 8, padding: 12, alignItems: 'center' },
  cancelBtnText: { color: '#6e6e85', fontWeight: '600', fontSize: 14 },
  emptyState: { alignItems: 'center', paddingVertical: 24, gap: 8 },
  emptyText: { fontSize: 15, color: '#2c2c3e', fontWeight: '600' },
  emptyHint: { fontSize: 13, color: '#9e9eaa', textAlign: 'center' },
  groupLabel: { fontSize: 11, fontWeight: '700', color: '#9e9eaa', letterSpacing: 1, marginBottom: 8 },
  row: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f4f0eb', borderRadius: 10, paddingVertical: 10, paddingHorizontal: 12, marginBottom: 8, gap: 10, borderWidth: 1, borderColor: '#e5ddd5' },
  ...
  rowName: { fontSize: 14, fontWeight: '600', color: '#2c2c3e' },
  rowDesc: { fontSize: 12, color: '#9e9eaa', marginTop: 2 },
