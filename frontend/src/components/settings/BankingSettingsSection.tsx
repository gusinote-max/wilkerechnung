...
const styles = StyleSheet.create({
  ...
  switchHint: { color: '#6e6e85', fontSize: 11, marginTop: 2 },
  ...
  radioButton: { flex: 1, minWidth: 80, backgroundColor: '#f4f0eb', borderRadius: 10, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: '#e5ddd5' },
  radioButtonActive: { backgroundColor: '#0984e330', borderColor: '#0984e3' },
  radioText: { fontSize: 13, color: '#6e6e85', fontWeight: '600' },
  ...
  saveBtnText: { color: '#2c2c3e', fontSize: 14, fontWeight: '600' },
});
