...
const styles = StyleSheet.create({
  ...
  workflowItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#e5ddd5' },
  workflowInfo: { flex: 1 },
  workflowName: { fontSize: 15, fontWeight: '600', color: '#2c2c3e' },
  workflowDesc: { fontSize: 13, color: '#6e6e85', marginTop: 2 },
  ...
  workflowHint: { fontSize: 12, color: '#9e9eaa', marginTop: 8 },
  buttonRow: { flexDirection: 'row', gap: 12, marginTop: 12 },
  cancelButton: { flex: 1, backgroundColor: '#e5ddd5', borderRadius: 10, padding: 14, alignItems: 'center' },
