...
const styles = StyleSheet.create({
  ...
  modelPickerButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f4f0eb', borderRadius: 10, padding: 14, borderWidth: 1, borderColor: '#e5ddd5', gap: 10 },
  modelPickerText: { flex: 1, fontSize: 15, color: '#2c2c3e' },
  modelHint: { fontSize: 12, color: '#9e9eaa', marginTop: 6 },
  radioGroup: { flexDirection: 'row', gap: 12 },
  radioButton: { flex: 1, backgroundColor: '#f4f0eb', borderRadius: 10, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: '#e5ddd5' },
  radioButtonActive: { backgroundColor: '#6c5ce730', borderColor: '#6c5ce7' },
  radioText: { fontSize: 14, color: '#6e6e85', fontWeight: '600' },
  radioTextActive: { color: '#6c5ce7' },
  hintText: { fontSize: 12, color: '#9e9eaa', marginTop: 8, fontStyle: 'italic' },
  ...
  saveButtonText: { color: '#2c2c3e', fontSize: 16, fontWeight: 'bold' },
  ...
  modalTitle: { fontSize: 18, fontWeight: 'bold', color: '#2c2c3e' },
  modelSearchInput: { backgroundColor: '#f4f0eb', borderRadius: 10, padding: 14, fontSize: 15, color: '#2c2c3e', borderWidth: 1, borderColor: '#e5ddd5', marginBottom: 12 },
  modelItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: '#e5ddd5' },
  modelItemActive: { backgroundColor: '#6c5ce715' },
  modelName: { fontSize: 14, fontWeight: '600', color: '#2c2c3e' },
  modelId: { fontSize: 12, color: '#9e9eaa', marginTop: 2 },
