...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 18, fontWeight: '700', color: '#2c2c3e', flex: 1 },
  userCount: { backgroundColor: '#6c5ce730', width: 28, height: 28, borderRadius: 14, justifyContent: 'center', alignItems: 'center' },
  userCountText: { color: '#6c5ce7', fontSize: 13, fontWeight: '700' },
  emptyText: { color: '#9e9eaa', fontSize: 14, textAlign: 'center', paddingVertical: 20 },
  userListItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#e5ddd5', gap: 12 },
  userListAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#6c5ce715', justifyContent: 'center', alignItems: 'center' },
  userListInfo: { flex: 1 },
  userListName: { fontSize: 15, fontWeight: '600', color: '#2c2c3e' },
  userInactive: { opacity: 0.5 },
  userListEmail: { fontSize: 13, color: '#6e6e85', marginTop: 2 },
  userRoleBadge: { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, marginRight: 8 },
  userRoleBadgeText: { fontSize: 12, fontWeight: '700' },
  ...
  addUserBtnText: { color: '#2c2c3e', fontSize: 15, fontWeight: '600' },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'center', padding: 20 },
  modalContent: { backgroundColor: '#ffffff', borderRadius: 16, padding: 20, maxWidth: 500, alignSelf: 'center', width: '100%' },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  modalTitle: { fontSize: 18, fontWeight: '700', color: '#2c2c3e' },
  userEditHeader: { alignItems: 'center', marginBottom: 24 },
  userEditName: { fontSize: 20, fontWeight: '700', color: '#2c2c3e', marginTop: 8 },
  userEditEmail: { fontSize: 14, color: '#6e6e85', marginTop: 4 },
  editInput: {
  ...
  userEditSectionTitle: { fontSize: 14, fontWeight: '600', color: '#6e6e85', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 1 },
  roleOption: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f4f0eb', borderRadius: 10, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: '#e5ddd5' },
  roleOptionSelected: { backgroundColor: '#6c5ce7', borderColor: '#6c5ce7' },
  roleOptionInfo: { flex: 1, marginLeft: 12 },
  roleOptionName: { fontSize: 15, fontWeight: '600', color: '#2c2c3e' },
  roleOptionNameSelected: { color: '#2c2c3e' },
  roleOptionDesc: { fontSize: 12, color: '#6e6e85', marginTop: 2 },
  ...
  userToggleBtnText: { color: '#2c2c3e', fontSize: 14, fontWeight: '600' },
  ...
  cancelButton: { alignItems: 'center', backgroundColor: '#e5ddd5', borderRadius: 8, padding: 12 },
  cancelButtonText: { color: '#6e6e85', fontSize: 14, fontWeight: '600' },
});
