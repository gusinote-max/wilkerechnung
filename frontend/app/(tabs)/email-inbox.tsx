...
const styles = StyleSheet.create({
  ...
  pollBtnText: { color: '#2c2c3e', fontWeight: '600', fontSize: 13 },
  ...
  batchImportText: { color: '#2c2c3e', fontWeight: '700', fontSize: 13 },
  ...
  btnPrimaryText: { color: '#2c2c3e', fontWeight: '700', fontSize: 12 },
  ...
  toastText: { color: '#2c2c3e', fontWeight: '600', fontSize: 14, flex: 1 },
  // Modal shared
  ...
  addRuleBtnText: { color: '#2c2c3e', fontWeight: '700', fontSize: 14 },
  ...
  periodBtnTextActive: { color: '#2c2c3e' },
