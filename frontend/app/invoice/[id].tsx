...
const styles = StyleSheet.create({
  ...
  statusHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#1a1a2e', padding: 20, borderLeftWidth: 4 },
  statusInfo: { flex: 1 },
  statusText: { fontSize: 14, fontWeight: 'bold', textTransform: 'uppercase' },
  invoiceNumber: { fontSize: 20, fontWeight: 'bold', color: '#fff', marginTop: 4 },
  ...
  invoiceImage: { width: '100%', height: 200, backgroundColor: '#1a1a2e' },
  ...
  imageOverlayText: { color: '#fff', marginLeft: 8, fontSize: 14 },
  section: { padding: 16 },
  sectionHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  sectionTitle: { fontSize: 16, fontWeight: 'bold', color: '#a0a0a0', marginBottom: 12 },
  ...
  vendorName: { fontSize: 18, fontWeight: 'bold', color: '#fff', marginBottom: 4 },
  vendorAddress: { fontSize: 14, color: '#a0a0a0', marginBottom: 12 },
  infoRow: { flexDirection: 'row', marginTop: 8 },
  infoLabel: { fontSize: 14, color: '#636e72', width: 80 },
  infoValue: { fontSize: 14, color: '#fff', flex: 1 },
  accountingCard: { backgroundColor: '#1a1a2e', borderRadius: 12, padding: 16, borderLeftWidth: 3, borderLeftColor: '#6c5ce7' },
  accountingRow: { marginBottom: 12 },
  accountingLabel: { fontSize: 12, color: '#636e72', marginBottom: 4 },
  accountingValue: { fontSize: 14, color: '#fff' },
  detailsGrid: { flexDirection: 'row', flexWrap: 'wrap', backgroundColor: '#1a1a2e', borderRadius: 12, padding: 8 },
  detailItem: { width: '50%', padding: 8 },
  detailLabel: { fontSize: 12, color: '#636e72', marginBottom: 4 },
  detailValue: { fontSize: 16, color: '#fff' },
  amountsCard: { backgroundColor: '#1a1a2e', borderRadius: 12, padding: 16 },
  amountRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  amountLabel: { fontSize: 16, color: '#a0a0a0' },
  amountValue: { fontSize: 16, color: '#fff' },
  amountLabelBold: { fontSize: 18, fontWeight: 'bold', color: '#fff' },
  amountValueBold: { fontSize: 18, fontWeight: 'bold', color: '#55efc4' },
  divider: { height: 1, backgroundColor: '#2d2d44', marginVertical: 12 },
  lineItem: { backgroundColor: '#1a1a2e', borderRadius: 8, padding: 12, marginBottom: 8 },
  lineItemDesc: { fontSize: 14, color: '#fff', marginBottom: 8 },
  lineItemDetails: { flexDirection: 'row', justifyContent: 'space-between' },
  lineItemQty: { fontSize: 13, color: '#a0a0a0' },
  ...
  gobdHashLabel: { fontSize: 12, color: '#a0a0a0' },
  gobdHash: { fontSize: 10, color: '#74b9ff', fontFamily: 'monospace', marginBottom: 8 },
  gobdDate: { fontSize: 12, color: '#a0a0a0' },
  ...
  auditContent: { flex: 1 },
  auditAction: { fontSize: 14, color: '#fff', textTransform: 'capitalize' },
  auditMeta: { fontSize: 12, color: '#636e72', marginTop: 2 },
  exportSection: { padding: 16, paddingBottom: 40 },
  desktopExport: { maxWidth: 600, alignSelf: 'center' },
  exportTitle: { fontSize: 14, color: '#a0a0a0', marginBottom: 12 },
  exportButtons: { flexDirection: 'row', gap: 12 },
  exportButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1a1a2e', padding: 14, borderRadius: 12, borderWidth: 1, borderColor: '#6c5ce7' },
  ...
  modalCancelText: { color: '#a0a0a0', fontSize: 16, fontWeight: '600' },
